<?php
$page_title = 'API設計 - AI×Web開発 中級編 | AI Tech Stack';
$current_page = 'design';
...
def delete_post(post_id: int, current_user = Depends(get_current_user)):
    ...
    return None</pre>
        ...
        <div class="flex justify-between items-center pt-8 border-t">
            <a href="component-design.php" class="flex items-center text-gray-600 hover:text-blue-600">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
                コンポーネント設計
            </a>
            <a href="database-design.php" class="flex items-center bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700">
                次へ：データベース設計
