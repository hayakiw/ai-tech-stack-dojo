<?php
$page_title = 'フォーム処理 - AI×Web開発 中級編 | AI Tech Stack';
$current_page = 'design';
  ...
  return (
    ...
    &lt;/div&gt;
        ...
        <div class="flex justify-between items-center pt-8 border-t">
            <a href="state-management.php" class="flex items-center text-gray-600 hover:text-pink-600">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
                状態管理
            </a>
            <a href="data-fetching.php" class="flex items-center bg-pink-600 text-white px-6 py-3 rounded-lg hover:bg-pink-700">
                次へ：データフェッチ
