<?php
$page_title = 'クリーンアーキテクチャをAIと実装 - AI駆動開発 上級編 | AI Tech Stack';
...
app.include_router(router)</pre>
        ...
        <div class="flex justify-between items-center pt-8 border-t">
            <a href="ai-architecture.php" class="flex items-center text-gray-600 hover:text-orange-600">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
                AIに設計を相談する
            </a>
            <a href="ai-refactoring.php" class="flex items-center bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600">
                次へ：既存コードのリファクタリング
