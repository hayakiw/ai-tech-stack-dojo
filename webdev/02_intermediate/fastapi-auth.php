<?php
$page_title = 'FastAPIで認証 - AI×Web開発 中級編 | AI Tech Stack';
$current_page = 'auth';
...
curl -X POST http://localhost:8000/posts \
  ...
  -d '{"title": "タイトル", "content": "本文"}'</pre>
        ...
        <div class="flex justify-between items-center pt-8 border-t">
            <a href="auth-basics.php" class="flex items-center text-gray-600 hover:text-purple-600">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
                認証の基礎
            </a>
            <a href="nextjs-auth.php" class="flex items-center bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700">
                次へ：Next.jsで認証
