...
?>
    ...
    <main class="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div class="bg-green-50 border-l-4 border-green-500 p-6 mb-8">
            <p class="text-lg">いよいよ実践編です！このページでは、チュートリアルで使用するNext.jsとFastAPIのプロジェクトを作成します。</p>
        </div>
        ...
        <!-- フォルダ作成 -->
        <section class="mb-12">
            <h2 class="text-2xl font-bold mb-6 pb-2 border-b-2 border-green-200">1. 作業フォルダの作成</h2>

            <p class="mb-4">まずチュートリアル用のフォルダを作成します。</p>
...
cd ai-todo-app</pre>
                ...
                <p class="text-sm text-gray-600 mt-3">この中にフロントエンドとバックエンドの両方を作成します。</p>
            </div>
        </section>

        <!-- Next.jsプロジェクト作成 -->
        <section class="mb-12">
            <h2 class="text-2xl font-bold mb-6 pb-2 border-b-2 border-green-200">2. Next.jsプロジェクトの作成</h2>

            <div class="bg-white p-6 rounded-lg shadow mb-6">
                <h3 class="font-bold mb-3">AIへの指示例（Claude Code）</h3>
                <div class="code-block p-4 rounded font-mono text-sm">
<pre>Next.jsプロジェクトを作成してください。
...
- src/ ディレクトリ: Yes</pre>
            ...
            <div class="bg-white p-6 rounded-lg shadow mb-6">
                <h3 class="font-bold mb-3">手動で作成する場合</h3>
                <div class="code-block p-4 rounded font-mono text-sm">
<pre>npx create-next-app@latest frontend</pre>
                </div>
                <p class="text-sm text-gray-600 mt-3">質問が表示されたら以下のように選択：</p>
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <h3 class="font-bold mb-3">動作確認</h3>
                <div class="code-block p-4 rounded font-mono text-sm">
<pre>cd frontend
npm run dev</pre>
                </div>
        ...
        <!-- FastAPIプロジェクト作成 -->
        <section class="mb-12">
            <h2 class="text-2xl font-bold mb-6 pb-2 border-b-2 border-green-200">3. FastAPIプロジェクトの作成</h2>

            <div class="bg-white p-6 rounded-lg shadow mb-6">
                <h3 class="font-bold mb-3">AIへの指示例（Claude Code）</h3>
                <div class="code-block p-4 rounded font-mono text-sm">
<pre>FastAPIプロジェクトを作成してください。

設定：
- フォルダ名: backend
- 必要なパッケージ: fastapi, uvicorn
- main.pyにHello Worldのエンドポイントを作成
- CORSを設定（localhost:3000からのアクセスを許可）</pre>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow mb-6">
                <h3 class="font-bold mb-3">手動で作成する場合</h3>
                <div class="code-block p-4 rounded font-mono text-sm">
<pre><span class="text-gray-400"># ai-todo-appフォルダにいることを確認</span>
mkdir backend
cd backend

<span class="text-gray-400"># 仮想環境を作成（推奨）</span>
python -m venv venv
...
<span class="text-gray-400"># パッケージをインストール</span>
pip install fastapi uvicorn</pre>
                </div>
            </div>

            <div class="bg-white p-6 rounded-lg shadow mb-6">
                <h3 class="font-bold mb-3">main.pyを作成</h3>
                <div class="code-block p-4 rounded font-mono text-sm">
...
<span class="text-gray-400"># CORSの設定</span>
app.add_middleware(
    CORSMiddleware,
...
<pre>uvicorn main:app --reload</pre>
                ...
                <p class="text-sm text-gray-600 mt-3">
                    ブラウザで <a href="http://localhost:8000" class="text-blue-600 hover:underline">http://localhost:8000</a> を開いて、JSONが表示されればOK！
                </p>
                <p class="text-sm text-gray-600 mt-2">
                    <a href="http://localhost:8000/docs" class="text-blue-600 hover:underline">http://localhost:8000/docs</a> でAPIドキュメントも確認できます。
                </p>
            </div>
        </section>
    ...
    └── ...</pre>
        ...
        <section class="mb-12">
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-500 p-4 mb-6">
                <p><strong>重要：</strong>開発中はフロントエンドとバックエンドの両方のサーバーを起動しておく必要があります。</p>
            </div>

            <div class="grid md:grid-cols-2 gap-6">
                <div class="bg-white p-4 rounded-lg shadow">
                    <h3 class="font-bold mb-3 text-blue-600">フロントエンド</h3>
...
npm run dev</pre>
                ...
                <div class="bg-white p-4 rounded-lg shadow">
                    <h3 class="font-bold mb-3 text-green-600">バックエンド</h3>
                    <div class="code-block p-3 rounded font-mono text-sm">
<pre>cd backend
uvicorn main:app --reload</pre>
            ...
            <div class="mt-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
                <p><strong>ヒント：</strong>ターミナルを2つ開いて、それぞれでサーバーを起動すると便利です。VS CodeやCursorでは「ターミナルの分割」機能が使えます。</p>
            </div>
        </section>
        ...
        <div class="bg-green-100 border border-green-300 rounded-lg p-6 mb-8">
            ...
            <p class="text-green-600">これでチュートリアルの準備が整いました。次のページから実際にアプリを作っていきます！</p>
        </div>
