<?php
$page_title = 'AI×Web開発 学習サイト | AI Tech Stack Dojo';
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
<body class="bg-gray-900 text-white">
    ...
    <nav class="absolute top-0 left-0 right-0 z-10">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="../index.php" class="text-white/80 hover:text-white font-bold">← Dojo</a>
        </div>
    </nav>
    ...
    <footer class="bg-gray-900 py-8 border-t border-gray-800">
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <a href="../index.php" class="text-xl font-bold mb-4 md:mb-0 hover:text-blue-400">AI Tech Stack Dojo</a>
